                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <button type="button" class="btn btn-success" id="btn-abrir-camera">
                                ...
                                <div id="reader" style="width: 100%; max-width: 500px; margin-top: 10px;"></div>
                            </div>
                        </div>
                        <div class="registro-opcoes mt-2 mb-2 mx-2">
