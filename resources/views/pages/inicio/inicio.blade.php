    ...
    <div class="container-fluid d-flex justify-content-center align-items-center vh-100 p-0 ponto-container">
        <div class="card ponto-card">
            ...
            <div class="text-center pt-4 pb-3">
                <img src="img/logotipo-dgp.png" alt="Brasão DGP" class="img-fluid brasao-topo">
            ...
            <div class="card-body">
                ...
                <div class="registro-opcoes mb-5">
                    ...
                    <a href="#" id="entradaBtn" class="registro-link entrada-link active">Entrada</a> 
                    | 
                    <a href="#" id="saidaBtn" class="registro-link saida-link">Segundo registro. Saída</a>
                </div>
